...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 01 2020 г., 10:11
...
--
ALTER TABLE `country`
  MODIFY `country_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7716096;
...
--
ALTER TABLE `city`
  ADD CONSTRAINT `City_fk_country` FOREIGN KEY (`country_id`) REFERENCES `country` (`country_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `City_fk_region` FOREIGN KEY (`region_id`) REFERENCES `region` (`region_id`) ON DELETE CASCADE;
COMMIT;
